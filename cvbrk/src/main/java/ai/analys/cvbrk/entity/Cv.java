...
public class Cv {
    ...
    public Cv(Long id, String titre, String path, LocalDateTime creatAt, User etudiant, List<Postule> postulants) {
        this.id = id;
        this.titre = titre;
        this.path = path;
    ...
    public String toString() {
        return "Cv(id=" + this.getId() + ", titre=" + this.getTitre() + ", path=" + this.getPath() + ", creatAt=" + this.getCreatAt() + ", etudiant=" + this.getEtudiant() + ", postulants=" + this.getPostulants() + ")";
    }
    ...
    public static class CvBuilder {
        ...
        public CvBuilder path(String path) {
            this.path = path;
            return this;
        }
        ...
        public Cv build() {
            return new Cv(this.id, this.titre, this.path, this.creatAt, this.etudiant, this.postulants);
        }

        public String toString() {
            return "Cv.CvBuilder(id=" + this.id + ", titre=" + this.titre + ", path=" + this.path + ", creatAt=" + this.creatAt + ", etudiant=" + this.etudiant + ", postulants=" + this.postulants + ")";
        }
    }
}
